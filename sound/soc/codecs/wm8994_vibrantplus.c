...
//QIK Setting
#define TUNING_QIK_OUTPUTL_VOL 0x2E //1Ch
#define TUNING_QIK_OUTPUTR_VOL 0x2E //1Dh
...
// Headset
#define TUNING_CALL_OUTPUTL_VOL		0x32		// 1Ch
#define TUNING_CALL_OUTPUTR_VOL		0x32		// 1Dh
#define TUNING_CALL_OPGAL_VOL		0x2F		// 20h
#define TUNING_CALL_OPGAR_VOL		0x2F		// 21h


//3POLE HEADSET
#define TUNING_CALL_OUTPUTL_VOL_3P		0x32		// 1Ch
#define TUNING_CALL_OUTPUTR_VOL_3P		0x32		// 1Dh
#define TUNING_CALL_OPGAL_VOL_3P		0x2F		// 20h
#define TUNING_CALL_OPGAR_VOL_3P		0x2F		// 21h

// Receiver
#define TUNING_RCV_OUTMIX5_VOL		0x0		// 31h
#define TUNING_RCV_OUTMIX6_VOL 		0x0		// 32h
#define TUNING_RCV_OPGAL_VOL		0x38		// 20h
#define TUNING_RCV_OPGAR_VOL		0x38		// 21h
...
#define TUNING_CALL_SPK_INPUTMIX_VOL	0x1d		// 18h
...
// ear loopback
#define TUNING_LOOPBACK_EAR_INPUTMIX_VOL 0x14 // 1Ah
...
void wm8994_set_playback_headset(struct snd_soc_codec *codec)
{
	...
	if(wm8994->testmode_config_flag == SEC_NORMAL)
	{
		...
		if(wm8994->ringtone_active)
			...
			val |= (WM8994_HPOUT1_VU | WM8994_HPOUT1L_MUTE_N | TUNING_QIK_OUTPUTR_VOL);
		else
...
else if(wm8994->testmode_config_flag == SEC_TEST_PBA_LOOPBACK) 
		{
			// Unmute IN1L PGA, update volume
		val = wm8994_read(codec, WM8994_LEFT_LINE_INPUT_1_2_VOLUME);	
		val &= ~(WM8994_IN1L_MUTE_MASK | WM8994_IN1L_VOL_MASK);
