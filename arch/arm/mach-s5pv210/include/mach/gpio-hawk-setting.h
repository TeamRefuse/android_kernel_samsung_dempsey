...
//	{S5PV210_GPH1(3), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_nINT_ONEDRAM_AP
	{S5PV210_GPH1(4), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},	//GPIO_GPH14
	{S5PV210_GPH1(5), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE},	//GPIO_GPH15 	//[HDLNC] REV 03 hawk NC

	{S5PV210_GPH1(6), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},	//SIM_nDETECT	//[HDLNC] REV 03 hawk
#if defined(CONFIG_ARIES_NTT)
...
//[HDLNC] REV 03 hawk	{S5PV210_GPH2(0), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},	//GPIO_GPH20
//[HDLNC] REV 03 hawk	{S5PV210_GPH2(1), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_ZERO, S3C_GPIO_PULL_NONE},	//GPIO_KBC1
//[HDLNC] REV 03 hawk	{S5PV210_GPH2(2), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},	//GPIO_KBC2
#if defined(CONFIG_ARIES_NTT)
	{S5PV210_GPH2(3), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},	//GPIO_PHONE_ACTIVE
#else
	{S5PV210_GPH2(3), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},	//[HDLNC] REV 03 hawk NC 
#endif
...
//	{S5PV210_GPH2(7), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_JACK_nINT
	...
	{S5PV210_GPH3(0), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},	//GPIO_KBR0	//[HDLNC] REV 03 hawk
	{S5PV210_GPH3(1), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_KBR1	//[HDLNC] REV 03 hawk
	{S5PV210_GPH3(2), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_KBR2	//[HDLNC] REV 03 hawk
	{S5PV210_GPH3(3), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE},	// Fuel_INT	//[HDLNC] REV 03 hawk
	{S5PV210_GPH3(4), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_T_FLASH_DETECT	//[HDLNC] REV 03 hawk
	{S5PV210_GPH3(6), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_EAR_SEND_END	//[HDLNC] REV 03 hawk
	{S5PV210_GPH3(7), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_NONE}, //GPIO_nPOWER	//[HDLNC] REV 03 hawk

#if defined(CONFIG_S5PC110_KEPLER_BOARD) || defined(CONFIG_S5PC110_FLEMING_BOARD)//[HDLNC] REV 03 hawk  || defined (CONFIG_S5PC110_HAWK_BOARD)
...
#else
//[HDLNC] REV 03 hawk 	{S5PV210_GPH3(7), S3C_GPIO_OUTPUT,	S3C_GPIO_SETPIN_ONE,  S3C_GPIO_PULL_NONE},	//GPIO_CP_RST
#endif	
};
