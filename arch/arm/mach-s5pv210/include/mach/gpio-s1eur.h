...
#else
#define GPIO_MENUKEY_INT			S5PV210_GPD1(2)
#define GPIO_MENUKEY_INT_AF		0xF				//NAGSM_Android_SEL_Kernel_Aakash_20101006

#define GPIO_BACKKEY_INT			S5PV210_GPD1(3)
#define GPIO_BACKKEY_INT_AF		0xF				//NAGSM_Android_SEL_Kernel_Aakash_20101006
...
#if defined (CONFIG_S5PC110_HAWK_BOARD) // NAGSM_Android_HQ_KERNEL_CLEE_20100830  search key for hak dosirak 0.1  
#define GPIO_SEARCHKEY_INT		S5PV210_GPH3(0)
#define GPIO_SEARCHKEY_INT_AF		2
#else
