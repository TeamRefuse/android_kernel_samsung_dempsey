...
#define GPIO_FLM_RXD 			0	//S5PV210_GPA1(2)	// GPIO_AP_ST_UART_RXD	
#define GPIO_FLM_RXD_AF 		2

#define GPIO_AP_FLM_TXD			S5PV210_GPA1(3)
#define GPIO_AP_FLM_TXD_AF		2
#define GPIO_FLM_TXD 			0	//S5PV210_GPA1(3)	// GPIO_AP_ST_UART_TXD
#define GPIO_FLM_TXD_AF 		2

/*GPB*/
#define GPIO_CMC_CLK_28V		S5PV210_GPB(0)
#define GPIO_CMC_CS_28V		S5PV210_GPB(1)
#define GPIO_CMC_DO_28V		S5PV210_GPB(2)
#define GPIO_CMC_DI_28V		S5PV210_GPB(3)

#define _3_TOUCH_SCL_28V				S5PV210_GPB(4)

#define _3_GPIO_TOUCH_EN			S5PV210_GPB(5)
#define _3_GPIO_TOUCH_EN_AF		1

#define _3_TOUCH_SDA_28V				S5PV210_GPB(6)

#define GPIO_GPB7				S5PV210_GPB(7)
#define GPIO_CAM_IO_EN				0 //S5PV210_GPB(7)
...
#define GPIO_UART_SEL			S5PV210_GPC1(0)

#define GPIO_GPC11				S5PV210_GPC1(1)
#define GPIO_A1026_RST			S5PV210_GPC1(1)
#define CAM_CORE_EN				0 //S5PV210_GPC1(1)

#define GPIO_GPC12				S5PV210_GPC1(2)
#define GPIO_ST_UART1_SEL		S5PV210_GPC1(2)
...
#define GPIO_BT_WAKE			S5PV210_GPD0(0)

#define GPIO_VIBTONE_PWM		S5PV210_GPD0(1)

#define GPIO_BT_EN			S5PV210_GPD0(2)

#define GPIO_GPD03				S5PV210_GPD0(3)
#define GPIO_BT_nRST			S5PV210_GPD0(3)
#define GPIO_BT_RST			S5PV210_GPD0(3)

#define FUEL_SDA_18V			S5PV210_GPD1(0)
#define FUEL_SCL_18V			S5PV210_GPD1(1)

#define GPIO_CAM_SDA_29V		S5PV210_GPD1(3)
#define GPIO_CAM_SDA_29V_AF		2

#define GPIO_CAM_SCL_29V		S5PV210_GPD1(4)
...
#define GPIO_ALS_SDA_18V		S5PV210_GPG1(2)
#define GPIO_PS_ALS_SDA_28V	GPIO_ALS_SDA_18V
...
#define GPIO_WLAN_nRST          S5PV210_GPG2(0)
#define GPIO_WLAN_nRST_AF	1
#define GPIO_WLAN_RST			S5PV210_GPG2(0)

#define GPIO_WLAN_SDIO_CLK      S5PV210_GPG2(1)
#define GPIO_WLAN_SDIO_CLK_AF   2

#define GPIO_WLAN_SDIO_CMD      S5PV210_GPG2(2)
#define GPIO_WLAN_SDIO_CMD_AF   2

//#define GPIO_ALS_SDA_28V		S5PV210_GPG2(2)
#define GPIO_GPG22			S5PV210_GPG2(2)

#define GPIO_WLAN_SDIO_D0       S5PV210_GPG2(3)
#define GPIO_WLAN_SDIO_D0_AF    2

#define GPIO_WLAN_SDIO_D1       S5PV210_GPG2(4)
#define GPIO_WLAN_SDIO_D1_AF    2

#define GPIO_WLAN_SDIO_D2       S5PV210_GPG2(5)
#define GPIO_WLAN_SDIO_D2_AF    2

#define GPIO_WLAN_SDIO_D3       S5PV210_GPG2(6)
#define GPIO_WLAN_SDIO_D3_AF    2

#define GPIO_T_FLASH_CLK		S5PV210_GPG3(0)
#define GPIO_T_FLASH_CLK_AF		2

#define GPIO_T_FLASH_CMD        S5PV210_GPG3(1)
#define GPIO_T_FLASH_CMD_AF		2

#define GPIO_MSENSOR_INT		S5PV210_GPG3(2)

#define GPIO_T_FLASH_D0         S5PV210_GPG3(3)
#define GPIO_T_FLASH_D0_AF		2

#define GPIO_T_FLASH_D1         S5PV210_GPG3(4)
#define GPIO_T_FLASH_D1_AF		2	

#define GPIO_T_FLASH_D2         S5PV210_GPG3(5)
#define GPIO_T_FLASH_D2_AF		2

#define GPIO_T_FLASH_D3         S5PV210_GPG3(6)
...
#define  _3_GPIO_TOUCH_INT		S5PV210_GPH0(5)
#define _3_GPIO_TOUCH_INT_AF		S3C_GPIO_SFN(0xf)

#define GPIO_DET_35				S5PV210_GPH0(6)
#define GPIO_DET_35_AF			0xFF

#define GPIO_T_FLASH_DETECT		S5PV210_GPH0(7)

#define GPIO_CP_ON				0	//S5PV210_GPH1(1)

#define GPIO_KBR3				S5PV210_GPH1(1)
#define GPIO_KBR3_AF			3

#define GPIO_ISP_INT			0	//S5PV210_GPH1(2)	
#define GPIO_RESET2_N			S5PV210_GPH1(2)

#define GPIO_nINT_ONEDRAM_AP		S5PV210_GPH1(3)
#define GPIO_nINT_ONEDRAM_AP_AF	0xF

#define GPIO_VOLUME_UP			S5PV210_GPH1(4)

#define GPIO_SIDE_RESET			S5PV210_GPH1(5)
...
#define GPIO_BUCK_2_EN			S5PV210_GPH2(1)

#define GPIO_ACC_INT			S5PV210_GPH2(2)
...
#define GPIO_AP_PMIC_IRQ		S5PV210_GPH3(4)
#define GPIO_AP_PMIC_IRQ_AF		0xFF

#define GPIO_MSENSE_IRQ			S5PV210_GPH3(5)

#define GPIO_PS_VOUT			S5PV210_GPH3(6)
#define GPIO_PS_VOUT_AF		0xF

#define GPIO_EAR_SEND_END		0	//S5PV210_GPH3(6)
#define GPIO_EAR_SEND_END_AF	0	//0xFF
...
/*GPJ*/
#define GPIO_SENSE_SCL_28V				S5PV210_GPJ3(7)
#define GPIO_SENSE_SDA_28V				S5PV210_GPJ3(6)
...
#define GPIO_PHONE_ON			0	//S5PV210_GPJ1(0)
...
#define CAM_LDO_SDA			0	//S5PV210_GPJ1(3)
//NAGSM_Android_SEL_Kernel_Aakash_20101018
...
#define GPIO_MASSMEMORY_EN2		0	//S5PV210_GPJ1(5)
...
#define GPIO_PDA_ACTIVE_HW_01		S5PV210_GPJ2(5)
...
#define GPIO_TA_CURRENT_SEL_AP	S5PV210_GPJ3(1)
...
#define GPIO_WLAN_BT_EN	S5PV210_GPJ3(2)


#define GPIO_PS_ALS_SCL_28V		S5PV210_GPG0(2)
...
#define GPIO_MSENSOR_SDA_28V			S5PV210_GPJ0(1)
#define GPIO_MSENSOR_SCL_28V			S5PV210_GPJ0(0)
#define AP_I2C_SDA_28V			S5PV210_GPJ0(1)
#define AP_I2C_SCL_28V			S5PV210_GPJ0(0)

#define ACC_GYRO_SDA_18V		S5PV210_GPJ3(6)
#define ACC_GYRO_SCL_18V		S5PV210_GPJ3(7)
...
#define GPIO_DISPLAY_SI			S5PV210_MP01(0)
#define GPIO_DISPLAY_SI_AF		S3C_GPIO_SFN(1)
#define GPIO_DISPLAY_DAT		S5PV210_MP01(0)
#define GPIO_DISPLAY_DAT_AF	S3C_GPIO_SFN(1)
...
#define GPIO_DIC_ID				0	//S5PV210_MP01(5)
#define GPIO_MLCD_RST			S5PV210_MP01(5)
...
#define GPIO_A1026_SCL			S5PV210_MP02(3)
...
#define GPIO_A1026_SDA			S5PV210_MP03(3)
...
#define GPIO_AP_SDA_28V			S5PV210_MP04(6)
#define GPIO_AP_SCL_28V			S5PV210_MP04(7)
...
#define GPIO_GPS_CLK_EN			0	//S5PV210_MP05(6)
