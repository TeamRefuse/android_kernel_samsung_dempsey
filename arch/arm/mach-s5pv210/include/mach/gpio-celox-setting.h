...
static unsigned int jupiter_sleep_gpio_table[][3] =
{
	...
	// GPG1 -------------------------------------------------
	{S5PV210_GPG1(0), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_GPS_nRST
	{S5PV210_GPG1(1), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_GPS_EN : MIDAS[2010.09.04] temporary out0 for sleep
	{S5PV210_GPG1(2), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//NC
...
#endif
	{S5PV210_GPG3(3), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},		//GPIO_WLAN_SDIO_D(0)
	{S5PV210_GPG3(4), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_WLAN_SDIO_D(1)
	{S5PV210_GPG3(5), S3C_GPIO_SLP_OUT0,  S3C_GPIO_PULL_NONE},	//GPIO_WLAN_SDIO_D(2)
	{S5PV210_GPG3(6), S3C_GPIO_SLP_OUT0, S3C_GPIO_PULL_NONE},		//GPIO_WLAN_SDIO_D(3)
...
#else
	{S5PV210_MP03(5), S3C_GPIO_SLP_OUT1,  S3C_GPIO_PULL_UP},	//GPIO_RESET_REQ_N
#endif
